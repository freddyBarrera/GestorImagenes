...
use GestorImagenes\Http\Requests\IniciarSessionRequest;
...
class ValidacionController extends Controller {
	...
	*/
	 ...
	 * @return \Illuminate\Http\Response
	 */
	public function postInicio(IniciarSessionRequest $request)
	{
	...
	public function postRecuperar(RecuperarContrasenaRequest $request)
	{
		...
		if($pregunta === $usuario->pregunta && $respuesta === $usuario->respuesta)
		{
			...
			return redirect('/validacion/inicio')->with(['recuperada' => 'La contraseña se cambió. Debe iniciar sesión.']);
		}
